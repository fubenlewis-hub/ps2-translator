...
| 文本提取 | 插件化架构：内置《心跳回忆3》插件、TM2 盘 DATA.DAT 容器插件、通用 Shift-JIS 扫描 |
...
1. **首页/流程**：选择 ISO → 「载入并检测游戏」→ 自动整盘提取并识别游戏（心跳回忆3 会自动命中专用插件）。
2. **提取结果**：查看文本量统计与术语表预览 → 「编辑术语表」。
3. **术语管理**：核对/添加/删除术语（内置了系列预设）；可「联网搜索更新」获取候选；「导入/导出」便于多人协作。
